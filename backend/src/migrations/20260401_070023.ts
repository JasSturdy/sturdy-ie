...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_challenge_cards_icon" AS ENUM('shield', 'layers', 'activity', 'globe');
  ...
  CREATE TABLE "challenge" (
  	...
  	"heading" varchar DEFAULT 'Building Challenge' NOT NULL,
  	"heading_light" varchar DEFAULT 'That Operates at Scale',
  	"body" jsonb DEFAULT '{"root":{"type":"root","children":[{"type":"paragraph","version":1,"children":[{"type":"text","text":"The systems required in regulated environments go beyond individual tools or platforms.","version":1}]},{"type":"paragraph","version":1,"children":[{"type":"text","text":"They are Challenge-level environments that integrate governance, security, and data exchange across organisations.","version":1}]}],"direction":"ltr","format":"","indent":0,"version":1}}'::jsonb,
  	"image_id" integer NOT NULL,
  	"image_caption" varchar DEFAULT 'Challenge designed to operate across public sector, financial systems, and health environments',
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE "footer" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"tagline" varchar NOT NULL,
  	"copyright" varchar DEFAULT 'Copyright © All Rights Reserved Jason Sturdy' NOT NULL,
  	"cta_label" varchar,
  	"cta_href" varchar,
