              ...
              {paginated.map((insight) => (
                ...
                >
                  <div className="flex w-full flex-col rounded-2xl border border-zinc-800 bg-gradient-to-b from-zinc-950/70 to-black p-6 transition-all duration-300 group-hover:border-[#DB4401]/70 group-hover:shadow-[0_0_60px_rgba(219,68,1,0.22)]">
                    ...
                    {/* Title */}
                    <h2 className="mt-6 text-[28px] font-light leading-[1.12] text-white transition-colors group-hover:text-[#ff944d]">
                      {insight.title}
                    </h2>
                    ...
                    <div className="mt-auto pt-8 flex items-center justify-end">
                      <span className="inline-flex items-center rounded-xl border border-zinc-700 bg-transparent px-6 py-3 text-sm font-semibold text-white transition-colors group-hover:border-[#ff5e00]/70 group-hover:text-[#ff944d]">
                        Read more
                      </span>
                    </div>
                  </div>
