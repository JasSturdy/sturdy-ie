        ...
        <div className="relative flex flex-col items-start gap-12 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="w-full space-y-8">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-4 pt-4">
              <Link
                href="/case-studies"
                className="inline-flex items-center justify-center gap-2 rounded-lg bg-[#c5f018] px-6 py-5 text-lg font-semibold transition duration-500 text-black hover:-translate-y-[1px] hover:bg-black hover:text-[#CCFF00] hover:border-1 hover:border-zinc-300 opacity-0"
              ...
              <Link
                href="/ventures"
                className="inline-flex items-center justify-center gap-2 rounded-lg border border-lime-400/70 bg-transparent px-6 py-5 text-lg font-semibold text-lime-300 transition duration-500 hover:-translate-y-[1px] hover:bg-[#CCFF00] hover:text-black opacity-0"
